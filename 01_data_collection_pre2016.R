# GOAL: data for auto regressive component of the price index (eq.1) and variables for further data cleaning
...
#   filter(recording_ <= as.Date("2024-04-01"))
...
t1415 <- read_csv("transfers_2014-2015.csv",
                           col_types = cols(.default = col_character()),
                           na = c("", "NA", "N/A"),
                           show_col_types = FALSE)

t1213 <- read_csv("transfers_2012-2013.csv",
                  col_types = cols(.default = col_character()),
                  na = c("", "NA", "N/A"),
                  show_col_types = FALSE)  


t1011 <- read_csv("transfers_2010-2011.csv",
                  col_types = cols(.default = col_character()),
                  na = c("", "NA", "N/A"),
                  show_col_types = FALSE) 


t89 <- read_csv("transfers_2008-2009.csv",
                  col_types = cols(.default = col_character()),
                  na = c("", "NA", "N/A"),
                  show_col_types = FALSE) 

t67 <- read_csv("transfers_2006-2007.csv",
                col_types = cols(.default = col_character()),
                na = c("", "NA", "N/A"),
                show_col_types = FALSE) 

t45 <- read_csv("transfers_2004-2005.csv",
                col_types = cols(.default = col_character()),
                na = c("", "NA", "N/A"),
                show_col_types = FALSE) 

t23 <- read_csv("transfers_2002-2003.csv",
                col_types = cols(.default = col_character()),
                na = c("", "NA", "N/A"),
                show_col_types = FALSE) 
...
sales_pre16 <- rbind(t1415, t1213, t1011, t89, t67, t45, t23) %>% 
  ...
  # filter(!document_id %in% document_id[duplicated(document_id)]) %>%  # removes doc ids with duplicates
  filter(
...
st_write(sales_pre16, "D:/R_data/00_Data_Clean/sales_pre16.gpkg",
         layer = "sales_pre16", append = FALSE)

# # cvs
# write.csv(sales_pre16, "D:/R_data/00_Data_Clean/sales_pre16.csv", row.names = FALSE)
